...
public class Curriculum_New_1_18 {
	...
	public static void hello(String x, int y) {
	...
	public static void display(int[] aryData) {
	...
	private static double average(int[] x) {
		...
		for (int i = 0; i < x.length; i++) {
			randomSum = randomSum + x[i];
		}
		randomAve = randomSum / x.length;
		return randomAve;
	...
	public static void main(String[] args) {
		...
		System.out.println(judge(average));
	}
}